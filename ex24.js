...
let ItemToCheck = 3; //define the number to be checked in the array
//using includes() method to check if the item is in the array and stored in the varaible called IsInArray
let IsInArray = myNumbers.includes(ItemToCheck);
...
let IsInArray2 = !myNumbers.includes(ItemToCheck);
